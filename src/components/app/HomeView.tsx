...
export function HomeView() {
  ...
  return (
    <div className="min-h-screen pb-4">
      <header className="sticky top-0 z-30 pt-safe-lg backdrop-blur-2xl transition-shadow duration-300" style={{ background: "rgba(247, 246, 244, 0.95)", boxShadow: scrolled ? "0 4px 20px rgba(0,0,0,0.06)" : "none", borderBottom: scrolled ? "1px solid rgba(0,0,0,0.04)" : "1px solid transparent" }}>
